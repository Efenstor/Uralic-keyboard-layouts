...
**ВНИМАНИЕ**: после установки ищите раскладку в настройках клавиатуры, в списке раскладок для России, если раскладка не видна - *перелогиньтесь* (или перезагрузитесь). В среде GNOME необходимо включить поддержку дополнительных источников ввода в GNOME Tweaks: *Клавиатура > Показывать дополнительные источники ввода*.
